...
\hypertarget{SDL__quit_8h_source}{}\label{SDL__quit_8h_source}\index{include/SDL/SDL\_quit.h@{include/SDL/SDL\_quit.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#ifndef\ SDL\_quit\_h\_}}
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#define\ SDL\_quit\_h\_}}
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#include\ "{}SDL\_stdinc.h"{}}}
\DoxyCodeLine{00043\ \textcolor{preprocessor}{\#include\ "{}SDL\_error.h"{}}}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \textcolor{comment}{/*\ There\ are\ no\ functions\ directly\ affecting\ the\ quit\ event\ */}}
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00047\ \textcolor{preprocessor}{\#define\ SDL\_QuitRequested()\ \(\backslash\)}}
\DoxyCodeLine{00048\ \textcolor{preprocessor}{\ \ \ \ \ \ \ \ (SDL\_PumpEvents(),\ (SDL\_PeepEvents(NULL,0,SDL\_PEEKEVENT,SDL\_QUIT,SDL\_QUIT)\ >\ 0))}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ SDL\_quit\_h\_\ */}\textcolor{preprocessor}{}}
